...
categories: [技术学习]  
# 封面  
cover: [https://blog-imges-1313931661.cos.ap-nanjing.myqcloud.com/aeecc37df29a25610d3d185900e38f8a.mp4.jpg](https://blog-imges-1313931661.cos.ap-nanjing.myqcloud.com/aeecc37df29a25610d3d185900e38f8a.mp4.jpg)  
banner: [https://blog-imges-1313931661.cos.ap-nanjing.myqcloud.com/aeecc37df29a25610d3d185900e38f8a.mp4.jpg](https://blog-imges-1313931661.cos.ap-nanjing.myqcloud.com/aeecc37df29a25610d3d185900e38f8a.mp4.jpg)  
poster:  # 海报（可选，全图封面卡片）  
  headline:  C++11 新特性
# C++ 11 新特性
## 1. auto 类型推导
...
> ![](https://blog-imges-1313931661.cos.ap-nanjing.myqcloud.com/image-20250306232555269.png)
>

4. 推导函数返回值类型![](https://blog-imges-1313931661.cos.ap-nanjing.myqcloud.com/image-20250306233422600.png)需要注意的是，不要直接推导不带参的函数，因为函数本质上是一个地址即 void* （感觉这个例子不好，应该定义一个返回值不是 void * 的函数进行区分）
...
第一行，使用了显式模版实例化，直接指定了模版参数类型为 <int, int>，这里获取的是函数模版实例化后的函数类型。第二行，使用了模版参数推导，编译器根据参数自动推导出模版参数类型，这里获取的函数返回值的类型。
